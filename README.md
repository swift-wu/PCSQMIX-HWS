...
**2.model-driven cooperative decision-making model:** A model-driven cooperative decision-making model is developed for intersection scenarios, which combines priority-aware safety optimization with hierarchical weighted sampling. By assigning passing priorities, optimizing global vehicle actions, and emphasizing informative high-reward samples during training, the framework improves both traffic safety and efficiency while enhancing the self-learning capability of CAVs.
